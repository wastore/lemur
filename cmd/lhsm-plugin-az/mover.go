...
// A debug transport  that implements the RoundTripper interface
// to dump the HTTP headers generated by the various storage clients
// before they go over the wire
type DebugTransport struct {}
func (t DebugTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	debug.Printf("HTTP HEADERS: %+v\n", req.Header)
	...
	resp, err := real_transport.RoundTrip(req)
	if err != nil {
		return resp, err
	}
